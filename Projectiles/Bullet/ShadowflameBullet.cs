...
namespace SpiritMod.Projectiles.Bullet
{
    public class ShadowflameBullet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num384 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Shadowflame, 0f, 0f, 0, default(Color), 1f);
