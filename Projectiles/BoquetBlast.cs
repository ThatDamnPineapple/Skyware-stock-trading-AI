...
namespace SpiritMod.Projectiles
{
	public class BoquetBlast : ModProjectile
    {
        ...
        {
            {
                if (Main.rand.Next(4) == 0) target.AddBuff(BuffID.CursedInferno, 180);
                if (Main.rand.Next(4) == 0) target.AddBuff(BuffID.Frostburn, 180);
                if (Main.rand.Next(4) == 0) target.AddBuff(BuffID.OnFire, 180);
                if (Main.rand.Next(4) == 0) target.AddBuff(BuffID.Ichor, 180);
            }
        }
