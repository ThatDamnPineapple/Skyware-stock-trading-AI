    ...
    public class PlantProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (timer == 0)
            {
                ...
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X + Main.rand.Next(-3, 5), projectile.velocity.Y + Main.rand.Next(-3, 5), mod.ProjectileType("HomingPlant"), 40, 2, projectile.owner, 0f, 0f);
                timer = 20;
            }
            {
                projectile.ai[1] += 1f;
