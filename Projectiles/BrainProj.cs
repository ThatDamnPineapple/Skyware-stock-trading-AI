...
namespace SpiritMod.Projectiles
{
	public class BrainProj : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                int num3 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)num, (float)num2, base.mod.ProjectileType("BoCShurikenProj"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
            ...
            {
                int num5 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, (float)num, (float)num2, base.mod.ProjectileType("?"), base.projectile.damage, base.projectile.knockBack, base.projectile.owner, 0f, 0f);
