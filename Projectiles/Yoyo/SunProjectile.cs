	...
	public class SunProjectile : ModProjectile
    {
         ...
         public override void AI()
        {
            ...
            if (projectile.frameCounter >= 10)
            {
                ...
                int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, velocity.X, velocity.Y, ProjectileID.HeatRay, projectile.damage, projectile.owner, 0, 0f);
