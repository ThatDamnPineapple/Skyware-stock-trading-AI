...
namespace SpiritMod.Projectiles.Thrown
{
	public class OrichKnifeProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Terraria.Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("OrichKnife"), 1, false, 0, false, false);
            }
            for (int i = 0; i < 5; i++)
            {
