...
namespace SpiritMod.Projectiles.Thrown
{
    public class EoWDaggerProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Terraria.Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("EoWDagger"), 1, false, 0, false, false);
            }
            {
                int n = 2;
            ...
            for (int i = 0; i < 5; i++)
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 196);
            }
        }
    }
}
