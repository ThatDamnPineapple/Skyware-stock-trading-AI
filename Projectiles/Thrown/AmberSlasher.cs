...
namespace SpiritMod.Projectiles.Thrown
{
    public class AmberSlasher : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Terraria.Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("AmberSlasher"), 1, false, 0, false, false);
            }
        }
