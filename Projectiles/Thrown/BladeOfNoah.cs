...
public override void Kill(int timeLeft)
        {
            ...
            {
                Terraria.Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("BladeOfNoah"), 1, false, 0, false, false);
            }
            for (int i = 0; i < 10; i++)
            {
