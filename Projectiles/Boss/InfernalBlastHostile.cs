       ...
       public override void AI()
	   {
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 4; i < 31; i++)
            {
                ...
                int newDust = Dust.NewDust(new Vector2(projectile.oldPosition.X - x, projectile.oldPosition.Y - y), 8, 8, 6, projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default(Color), 1.8f);
