    ...
    public class ScarabDust1 : ModProjectile
    {
        ...
        public override bool PreAI()
        {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    int num = Dust.NewDust(new Vector2(x, y), 26, 26, DustID.GoldCoin, 0f, 0f, 0, default(Color), 1f);
       ...
       public override void AI()
	   {
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 4; i < 31; i++)
            {
                ...
                int newDust = Dust.NewDust(new Vector2(projectile.oldPosition.X - x, projectile.oldPosition.Y - y), 8, 8, DustID.GoldCoin, projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default(Color), 1.8f);
