...
namespace SpiritMod.Projectiles.Magic
{
    public class GraniteSpike1 : ModProjectile
    {
        ...
        {
            projectile.Kill();
            Dust.NewDust(projectile.position + projectile.velocity * 0, projectile.width, projectile.height, 187, projectile.oldVelocity.X * 0, projectile.oldVelocity.Y * 0);
            return false;
        }
        public override void Kill(int timeLeft)
        {
...

            {
                ...
                int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, velocity.X, velocity.Y, mod.ProjectileType("GraniteShard1"), 13, projectile.owner, 0, 0f);
