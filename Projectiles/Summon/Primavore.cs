...
public override bool OnTileCollide(Vector2 oldVelocity)
        ...
        public override void AI()
        {
           ...
           // string SlopeText = actualangle.ToString();
            ...
            if (actualangle >= 11.5f && actualangle < 22.5f)
            {
                projectile.frame = 1;
            }
            if (actualangle >= 22.5f && actualangle < 67.5f)
            {
                projectile.frame = 2;
            }
            if (actualangle >= 67.5f && actualangle < 112.5f)
            {
                projectile.frame = 3;
            }
            if (actualangle >= 112.5f && actualangle < 157.5f)
            {
                projectile.frame = 4;
            }
            if (actualangle >= 157.5f && actualangle < 168.5f)
            {
                projectile.frame = 5;
            }
            if (actualangle >= 168.5f)
            {
                projectile.frame = 6;
            }
