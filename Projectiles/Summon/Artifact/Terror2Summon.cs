    ...
    public class Terror2Summon : Minion
    {
        ...
        public override void Behavior()
        {
            ...
            if (base.projectile.ai[0] == 0f && flag)
            {
                ...
                if (base.projectile.ai[1] == 0f)
                {
                    ...
                    if (Main.myPlayer == base.projectile.owner)
                    {
                        ...
                        vector2.Normalize();
                        vector2 *= 9f;
                        int num8 = Terraria.Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector2.X, vector2.Y, base.mod.ProjectileType("WitherShard2"), 15, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
            ...
            if (base.projectile.ai[0] == 0f)
            {
                ...
                {
                    int num9 = Dust.NewDust(base.projectile.position, base.projectile.width, base.projectile.height / 2, 60, 0f, 0f, 0, default(Color), 1f);
            ...
            else if (Main.rand.Next(3) == 0)
            {
                ...
                int num10 = Dust.NewDust(base.projectile.position, base.projectile.width, base.projectile.height, 60, 0f, 0f, 0, default(Color), 1f);
            ...
            if (Main.rand.Next(60) == 0)
            {
                ...
                if (dum2 != -1)
                {
                    ...
                    if (flags)
                    {
                        ...
                        values *= dum5;
                        int p = Terraria.Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, values.X, values.Y, mod.ProjectileType("WitherShard1"), 22, projectile.knockBack / 2f, projectile.owner, 0f, 0f);
