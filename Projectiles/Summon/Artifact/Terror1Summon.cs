            ...
            if (base.projectile.ai[0] == 0f && flag)
            {
                ...
                if (base.projectile.ai[1] == 0f)
                {
                    ...
                    if (Main.myPlayer == base.projectile.owner)
                    {
                        ...
                        vector2.Normalize();
                        vector2 *= 9f;
                        int num8 = Terraria.Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector2.X, vector2.Y, base.mod.ProjectileType("WitherShard1"), 15, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
