...
namespace SpiritMod.Projectiles.Boss
{
    public class InfernalBeam : ModProjectile
    {
        ...
        {
            float num2 = 0f;
            if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), projectile.Center, projectile.Center + projectile.velocity * projectile.localAI[1], 30f * projectile.scale, ref num2))
            {
                return true;
            }
            return false;
