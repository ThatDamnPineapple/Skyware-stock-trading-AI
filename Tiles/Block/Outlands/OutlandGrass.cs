...
{
	public class OutlandGrassTile : ModTile
	{
		public override void SetDefaults()
		{
			Main.tileSolid[Type] = true;
			SetModTree(new OutlandTree());
			Main.tileMerge[Type][mod.TileType("OutlandGrassTile")] = true;
		...
		{
			style = 0;
			return mod.TileType("OutlandSapling");
		}
